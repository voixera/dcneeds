...
module.exports = {
  ...
  ocrEnabled: toBool(process.env.OCR_ENABLED, !process.env.RAILWAY_ENVIRONMENT),
  ocrLanguage: process.env.OCR_LANGUAGE || 'eng',
  ocrTimeoutMs: toInt(process.env.OCR_TIMEOUT_MS, 30 * 1000),
  ocrMaxConcurrent: Math.max(1, toInt(process.env.OCR_MAX_CONCURRENT, 1)),
  ocrImageMaxDimension: Math.max(320, toInt(process.env.OCR_IMAGE_MAX_DIMENSION, 960)),
